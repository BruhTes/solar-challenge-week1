...
# --- Page Configuration ---
st.set_page_config(
    page_title= "MoonLight Energy | Solar Investment Dashboard",
    page_icon="☀️",
    layout="wide",
...
# --- Sidebar for Filters ---
st.sidebar.title("🌍 Region Selection & Filters")
...
if not selected_countries:
    st.warning("Select at least one region from the sidebar to display the analysis.")
...
st.title("☀️ MoonLight Energy - Solar Investment Dashboard")
st.markdown("Analyze and compare solar potential across selected regions using key irradiance and environmental metrics.")

# --- Section 1: Irradiance Comparison ---
st.header("📊 Irradiance Profile During Daylight Hours (GHI > 10 W/m²)")
...
# --- Footer ---
st.markdown("---")
st.caption("Dashboard developed by Biruh Tesfahun | © 2025 MoonLight Energy Solutions")
